...
- `.Codex/rules/feature-generation-patterns.md` (F1-F9)
- `memory/test-generation-patterns.md`
- `.Codex/rules/ci-generation-patterns.md` (C1-C6)
...
Read `.Codex/rules/feature-generation-patterns.md` in full, then audit ALL source code changes against each pattern:
