...
Usage:
    git diff --name-only origin/main... | python .claude/scripts/select_tests_for_changes.py
    pytest $(git diff --name-only origin/main... | python .claude/scripts/select_tests_for_changes.py)
"""
