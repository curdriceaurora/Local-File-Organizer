...
This documentation supports File Organizer 2.2.0. To read older versions, look at the [GitHub releases](https://github.com/curdriceaurora/Local-File-Organizer/releases).
