...
class FolderPreferenceLearner:
    ...
    def _save_preferences(self) -> None:
        ...
        with open(storage_path, "w") as f:  # noqa: safedir-required, atomic-write  # folder learner writer — path is an internal data file
    ...
    def _load_preferences(self) -> None:
        ...
        try:
            with open(storage_path) as f:  # noqa: safedir-required, atomic-write  # folder learner reader — path is an internal data file
                data = json.load(f)
