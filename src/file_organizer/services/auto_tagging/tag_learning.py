...
class TagLearningEngine:
    ...
    def _save_data(self) -> None:
        ...
        try:
            ...
            with open(storage_path, "w") as f:  # noqa: safedir-required, atomic-write  # tag learning writer — path is an internal storage file
    ...
    def _load_data(self) -> None:
        ...
        try:
            with open(storage_path) as f:  # noqa: safedir-required, atomic-write  # tag learning reader — path is an internal storage file
                data = json.load(f)
