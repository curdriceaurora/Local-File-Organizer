...
class JohnnyDecimalConfig:
    ...
    def save_to_file(self, path: Path) -> None:
        ...
        with open(path, "w") as f:  # noqa: safedir-required, atomic-write  # JD config writer — path is an internal config file
    ...
    def load_from_file(cls, path: Path) -> JohnnyDecimalConfig:
        ...
        with open(path) as f:  # noqa: safedir-required, atomic-write  # JD config reader — path is an internal config file
            data = json.load(f)
