...
class JohnnyDecimalSystem:
    ...
    def save_configuration(self, path: Path | None = None) -> None:
        ...
        with open(save_path, "w") as f:  # noqa: safedir-required, atomic-write  # JD system writer — path is an internal data file
    ...
    def load_configuration(self, path: Path | None = None) -> None:
        ...
        with open(load_path) as f:  # noqa: safedir-required, atomic-write  # JD system reader — path is an internal data file
            config = json.load(f)
