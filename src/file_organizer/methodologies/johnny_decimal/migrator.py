...
class JohnnyDecimalMigrator:
    ...
    def _create_backup(self, root_path: Path) -> Path:
        ...
        shutil.copytree(root_path, backup_path)  # noqa: safedir-required, atomic-write  # JD migration backup — root/backup paths are validated at migration start
    ...
    def _save_rollback_info(self, rollback_info: RollbackInfo) -> None:
        ...
        with open(rollback_file, "w") as f:  # noqa: safedir-required, atomic-write  # JD rollback writer — rollback file is an internal temp file
