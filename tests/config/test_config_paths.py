...
class TestGetConfigDir:
    ...
    @pytest.mark.skipif(sys.platform != "darwin", reason="See #1030 - macOS-specific path validation")
    ...
    @pytest.mark.skipif(sys.platform != "linux", reason="See #1030 - Linux-specific path validation")
    ...
    @pytest.mark.skipif(sys.platform != "win32", reason="See #1030 - Windows-specific path validation")
