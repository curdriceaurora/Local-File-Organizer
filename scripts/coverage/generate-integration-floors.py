...
Usage:
    python scripts/coverage/generate-integration-floors.py [--json PATH] [--pyproject PATH]
...
def main() -> None:
    ...
    try:
        ...
        print(
            "Run: bash scripts/coverage/measure-integration-coverage.sh --cov-report=json:.coverage-integration.json",
            file=sys.stderr,
        )
        sys.exit(1)
